...
- DataLab response dates, time units, and breakdown group codes should be checked against the endpoint contract before caching.
...
The accepted cache TTL range is 0 through 31,536,000 seconds (365 days).
